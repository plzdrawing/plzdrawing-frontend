...
const loginStyles = {
  ...
  google: tw`bg-white border border-black`,
  apple: tw`bg-white border border-black`,
  signup: tw`bg-white border border-main-yellow`,
};
  ...
  return (
    <Pressable
      style={[
        ...
        variant === 'default' ? tw`py-[12px]` : tw`py-[16px] border border-main-yellow`,
        variant === 'auth' && loginType ? loginStyles[loginType] : {},
        !isValid ? tw`bg-sub-yellow/35 border border-main-yellow` : {},
