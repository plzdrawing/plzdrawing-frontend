...
export default function AlertModal({ modalTitle, buttonTitle, onClickButton }: AlertModalProps) {
  return (
    <Modal
      transparent={true}
      visible={true}
    ...
    >
      <View style={tw`flex-1 justify-center items-center bg-black/30`}>
        <View
          style={tw`w-[326px] h-[150px] flex-col justify-between items-center bg-white rounded-[12px]`}
        >
